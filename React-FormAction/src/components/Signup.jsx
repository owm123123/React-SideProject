...
export function submitSignup(pervData, formData) {
...
export default function Signup() {
  ...
  return (
    <form action={formAction}>
      ...
      {/* {console.log(formState.enteredValues?.role)} */}
      <div className="control">
      ...
      {/* input checkBox 的 default 要用 "defaultChecked" */}
      <fieldset>
